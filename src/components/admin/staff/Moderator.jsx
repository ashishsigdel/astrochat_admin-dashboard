  ...
  return (
    <div className="p-1 w-full">
      <div className="flex justify-between p-2 flex-wrap px-3">
        <p className="text-xl font-semibold">Moderator Manage</p>
        ...
        <div className="overflow-x-auto bg-white">
          ...
          <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              ...
              {modData.map((moderator) => (
                <tbody key={moderator.id}>
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-1 py-4">
                      <div>
                        <p className="text-black font-semibold text-sm">
                          Email:{" "}
                          <span className="font-normal">{moderator.email}</span>
                        </p>
                      </div>
                    </td>
                    <td class="px-1 py-4">
                    ...
                    <td class="px-1 py-4">
                      <div>
                        <p className="text-black font-semibold text-sm">
                          Phone Number:{" "}
                          <span className="font-normal">{moderator.phone}</span>
                        </p>
                      </div>
                    </td>
                    <td class="px-1 py-4">
