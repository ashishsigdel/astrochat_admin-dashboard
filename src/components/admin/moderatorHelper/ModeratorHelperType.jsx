...
export default function ModeratorHelperType() {
  const [openModal, setOpenModal] = useState(false);

  const messageType = [
    {
      SN: 1,
      title: "Astrologer Helper type",
    },
  ];
  ...
  return (
    <div className="p-1 w-full">
      <div className="flex justify-between p-2 flex-wrap items-center">
        <p className="text-xl font-semibold">Moderator Helper Template Type</p>
        <div className="flex gap-1 text-gray-500">
          <p className="text-blue-500">Dashboard</p>
          <p>/</p>
          <p>Moderator Helper</p>
          <p>/</p>
          <p>Type</p>
        </div>
      </div>
          ...
          <div className="fixed z-[999] bg-slate-300 mx-[10rem] p-3 w-[35rem]  border  rounded-md bg-red">
            <div className="">
              <div className="border-b flex justify-between text-2xl font-semibold">
                <p>Add Moderator Helper Template Type</p>
                <div
