...
export default function TicketUser({ data }) {
  return (
    <div className="pt-5 pb-10 m-2 border border-gray-300 border-t-2 border-t-blue-500 rounded-lg flex flex-col text-sm flex-wrap bg-white w-full justify-center items-center">
