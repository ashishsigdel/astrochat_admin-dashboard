...
export default function PaidQuestions() {
                    ...
                    <form className="max-w-sm mx-auto">
                      ...
                      >
                        {messageType.map((type) => (
                          <option key={type} selected={question.Answered}>
                            {type}
                          </option>
                        ))}
                      </select>
